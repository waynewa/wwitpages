const projects = [
  {
    id: 1,
    name: 'WWiTSeleniumBase',
    description:
      'This C# Selenium framework tests APIs, web UIs, and mobile applications. It utilizes the power of Selenium to automate the testing process, ensuring that everything works as intended. With its versatile capabilities, this framework provides a comprehensive solution for testing across multiple platforms.',
    url: 'https://github.com/waynewa/WWiTSeleniumBase',
  ...
  },
  {
    ...
    url: 'https://github.com/waynewa/WWiTSeleniumJ',
    type: 'Test Automation',
    image: 'favicon.ico',
  },
  {
  ...
  },
  {
    ...
    url: 'https://2pluscleaning.netlify.app',
    type: 'Web development',
    image: '2plusscreenshot.jpg',
  },
];
